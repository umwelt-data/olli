...
`olli` exposes three entry points. They all render the same kind of accessible tree and return the same `OlliHandle`; they differ in what they accept as input.
